...
& "d:\Obsidian Vaults\ALUX\.venv\Scripts\python.exe" "08_AUTOMATION\Scripts\cli.py" analyze "02_SCRIPTS\Draft\The_Rise_of_AI.md"

# 3. Find and Score B-Roll Footage
& "d:\Obsidian Vaults\ALUX\.venv\Scripts\python.exe" "08_AUTOMATION\Scripts\cli.py" broll "02_SCRIPTS\Draft\The_Rise_of_AI.md"

# 4. Search and Match SFX Sound Layers
& "d:\Obsidian Vaults\ALUX\.venv\Scripts\python.exe" "08_AUTOMATION\Scripts\cli.py" sfx "02_SCRIPTS\Draft\The_Rise_of_AI.md"

# 5. Fact Check Claims and Generate Source Notes
& "d:\Obsidian Vaults\ALUX\.venv\Scripts\python.exe" "08_AUTOMATION\Scripts\cli.py" news "02_SCRIPTS\Draft\The_Rise_of_AI.md"
